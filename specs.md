...
- All non-logo landing page elements are intentionally much smaller than the logo.
...
- Keep the install command and icon actions at a much smaller visual scale than the logo.
